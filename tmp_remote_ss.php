...
class SocialSecurityController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $pendingMap = InsuranceLimitPendingChange::where('target_type', 'social_security_region')
    ...
    public function show($id)
    {
        ...
        $pending = InsuranceLimitPendingChange::where('target_type', 'social_security_region')
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($hasLimitChange) {
            ...
            unset($updateData['min_base_amount'], $updateData['max_base_amount']);
        }
        ...
        if ($shouldDetect) {
            ...
            $importResult = $detectionService->detectAndImport('social_security', $oldData, $region->toArray(), $region->id);
        }
