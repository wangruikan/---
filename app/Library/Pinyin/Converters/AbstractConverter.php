...
use App\Library\Pinyin\Contracts\ConverterInterface;
use App\Library\Pinyin\ToneStyle;
...
abstract class AbstractConverter implements ConverterInterface
{
    ...
    protected static function getDataBasePath(): string
    {
        if (self::$dataBasePath === null) {
            self::$dataBasePath = realpath(__DIR__ . '/../../data') ?: (__DIR__ . '/../../data');
        }
        return self::$dataBasePath;
    }

    protected function getCharsPath(): string
    {
        return self::getDataBasePath() . '/chars.php';
    }

    protected function getSurnamesPath(): string
    {
        return self::getDataBasePath() . '/surnames.php';
    }
    ...
    protected function wordSegmentPaths(): array
    {
        ...
        $pattern = self::getDataBasePath() . '/words-*.php';
        $paths = glob($pattern);
