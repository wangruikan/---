...
class Employee extends Model
{
    ...
    protected $casts = [
        ...
        'id_card_valid_from' => 'date:Y-m-d',
        'id_card_valid_until' => 'date:Y-m-d',
        'social_insurance_enrollment_date' => 'date:Y-m-d',
        'provident_fund_enrollment_date' => 'date:Y-m-d',
        'medical_insurance_enrollment_date' => 'date:Y-m-d',
        'large_medical_enrollment_date' => 'date:Y-m-d',
