 ...
 */
export function exportSocialSecurityToExcelSimple(data, title, columns, filename) {
  // 创建工作簿
  ...
  // 设置样式 - 使用更简单的方法
  setSimpleExcelStyles(ws, exportData, columns, title)
 ...
 * @param {String} title - 标题
 */
function setSimpleExcelStyles(ws, exportData, columns, title) {
  const merges = []
